...
return {
	ACTIONFAIL =
	{
        ...
        BUILD =
        {
            MOUNTED = "Maybe I can throw this so it reaches the floor... Bad idea.",
            HASPET = "But my little butterfly...",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Good idea. If you want to get tramppled of course.",
			GENERIC = "I wouldn't try to shave that!",
			NOBITS = "I've already did it, don't make me do it again!",
            REFUSE = "only_used_by_woodie",
		},
		STORE =
		{
			GENERIC = "I don't think I can fit something there.",
			NOTALLOWED = "Sure... Nop, I can't put this there.",
			INUSE = "I would do it, but some other being is hoarding all the attention.",
            NOTMASTERCHEF = "Maybe I should learn to cook before that.",
		},
        CONSTRUCT =
        {
            INUSE = "Someone beat me to it.",
            NOTALLOWED = "It won't fit that easily... I won't try, by the way.",
            EMPTY = "Unfortunately I can't build with non-existent things.",
            MISMATCH = "Oopsie! That shouldn't be that way.",
        },
		RUMMAGE =
		{	
			GENERIC = "I'm not doing that!.",
			INUSE = "Nop. Nop. Nop. Gross. Nop...",
            NOTMASTERCHEF = "Maybe I should learn to cook before that.",
		},
		UNLOCK =
        {
        	WRONGKEY = "I dont't think this fits... Nope.",
        },
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "Oopsie! That wasn't right.",
        	KLAUS = "I'm a little preoccupied!!",
			QUAGMIRE_WRONGKEY = "I'll just have to find another key.",
        },
		ACTIVATE = 
		{
			LOCKED_GATE = "Looks like I shall not pass.",
		},
        COOK =
        {
            GENERIC = "I wouldn't cook at the moment.",
            INUSE = "Looks like we had the same idea.",
            TOOFAR = "I know I'm like magical and all that stuff but I would appreciate getting closer.",
        },
        ...
        GIVE =
        {
            GENERIC = "I wouldn't give this...",
            DEAD = "The dead are too busy for this.",
            SLEEPING = "Ewww, they're snoring. Gross.",
            BUSY = "They look occupied right now...",
            ABIGAILHEART = "Helska would surely make it work... Not me.",
            ...
            SLOTFULL = "There's something blocking my attempt.",
            FOODFULL = "There's already a meal there.",
            NOTDISH = "It is a bit more exquisite with its food...",
            ...
            CANTSHADOWREVIVE = "Sadly it won't be brought back to life.",
        ...
        GIVETOPLAYER =
        {
            FULL = "Maybe I can... I don't know... Fit it in your mounth?",
            DEAD = "The dead are too busy for this.",
            SLEEPING = "Ewww, they're snoring. Gross.",
            BUSY = "They look occupied right now...",
        },
        ...
        WRITE =
        {
            GENERIC = "I wouldn't change this beautiful piece of art.",
            INUSE = "There's only room for one scribbler.",
        },
        DRAW =
        {
            NOIMAGE = "I know I'm a great artist and all that but I would rather knowing what I am going to draw.",
        },
        CHANGEIN =
        {
	...
	ANNOUNCE_BOAT_LEAK = "Kurwa, woda is rising.",
	ANNOUNCE_BOAT_SINK = "Maybe Merenni and his pussycats can save me...",
	...
	ANNOUNCE_BEES = "KURWAAAAAAA BEEEEES!!!!",
	ANNOUNCE_BOOMERANG = "Ow! I should try to catch that!",
	ANNOUNCE_CHARLIE = "So your name's Charlie? Hello fella!!",
	ANNOUNCE_CHARLIE_ATTACK = "Kurwa! Charlie! That was not polite!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "Bah It was cooler in Helska's castle",
	ANNOUNCE_HOT = "I literally went to Hell, why is here hotter?",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing a couple key ingredients.",
	ANNOUNCE_DEERCLOPS = "Kurwa, the deer-thing's coming my way",
	ANNOUNCE_CAVEIN = "Nice, stalactite rain!",
	ANNOUNCE_ANTLION_SINKHOLE = 
	{
		"May Helska close this up!",
		"I'm shaking!",
	...
	ANNOUNCE_SACREDCHEST_YES = "Of course I'm worthy, what did you think?.",
	ANNOUNCE_SACREDCHEST_NO = "It didn't like that.",
    ANNOUNCE_DUSK = "I'm not afraid of the dark, but I like actually seeing.",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "A piece of gastronomy!",
		PAINFUL = "My stomach is resigning.",
		SPOILED = "Ewww! Why did I eat that?!",
		STALE = "Not a piece of gastronomy, at least not after all that time.",
		INVALID = "I wouldn't try eating that!",
        YUCKY = "NOPE! I'm not that hungry anyways",
    ...
    {
        "Huff... Pant...",
        "Maybe my shoulders feel a bit heavy...",
        "Lift... with your back...",
        "This isn't... princess's work...",
        "For... angaria?... oof!",
	...
	ANNOUNCE_ENTER_DARK = "I would prefer seeing what I'm killing",
	ANNOUNCE_ENTER_LIGHT = "I see ya!",
	ANNOUNCE_FREEDOM = "I'm free! Well... I'm still prisioner of your eyes...",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now! Not like I wasn't...",
	ANNOUNCE_HOUNDS = "The puppies are nearby!",
	ANNOUNCE_WORMS = "Did you feel that?",
	ANNOUNCE_HUNGRY = "I would eat a horse!",
    ...
    ANNOUNCE_NOWARDROBEONFIRE = "Really? On fire? How original...",
    ANNOUNCE_NODANGERGIFT = "I'm always eager for some gifts but this seems a bit too extreme",
    ANNOUNCE_NOMOUNTEDGIFT = "I should get off my beefalo first.",
	ANNOUNCE_NODANGERSLEEP = "I'm occupied figthing for my life",
	ANNOUNCE_NODAYSLEEP = "It's too bright out.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "I'll see no tomorrow if I sleep hungry",
	ANNOUNCE_NOSLEEPONFIRE = "I don't exactly have a burning desire to sleep in that. But I do with you anyways...",
	ANNOUNCE_NODANGERSIESTA = "I'm occupied figthing for my life",
	ANNOUNCE_NONIGHTSIESTA = "If I do that I would wake up tomorrow",
	...
	ANNOUNCE_NODANGERAFK = "Coward! Must fight on!",
	...
	ANNOUNCE_SHELTER = "A tree! A rain fencing tree! How original!",
	ANNOUNCE_THORNS = "Kurwa!",
	ANNOUNCE_BURNT = "Yikes! That was hot! Not as hot as you anyways...",
	ANNOUNCE_TORCH_OUT = "My torch's dead! Helska may bring back it to life!",
	...
	ANNOUNCE_WORMHOLE = "Every time I travel through a portal my head gets dizy, why do I do that?",
	...
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Ha! Good try Jer-Jaza!",
	ANNOUNCE_TOADESCAPING = "The toad is losing interest.",
	ANNOUNCE_TOADESCAPED = "The toad got away.",


	ANNOUNCE_DAMP = "Oh, H2O.",
	ANNOUNCE_WET = "I'm wet. And no, sadly it is fault of the weather",
	ANNOUNCE_WETTER = "At least the but's sock is dry... I think.",
	ANNOUNCE_SOAKED = "I'm as wet as when I see you... So a lot.",

	ANNOUNCE_WASHED_ASHORE = "I'm wet, but alive.",

    ANNOUNCE_DESPAWN = "I can see the light!",
	ANNOUNCE_BECOMEGHOST = "Now, sadly, I can only be touched by your presence my dear...",
    ANNOUNCE_GHOSTDRAIN = "My mortal body gets away... Not like I needed it, but it was cool",
	ANNOUNCE_PETRIFED_TREES = "The trees scream? How original",
	...
	BATTLECRY =
	{
		GENERIC = "Dla Jer-Jazaaa!",
		PIG = "Die you abomination",
		PREY = "I will pierce your heart",
		SPIDER = "Forgive me but I don't like spiders",
		SPIDER_WARRIOR = "Well, to be fair it doesn't look like you want something nice with me...",
		DEER = "Just like in the battle of Shar Shelaizer!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Their formation is broken, maintain the ofensive!",
		PIG = "I'll let him go. This time.",
		PREY = "He's too fast!",
		SPIDER = "Well, if I wanted him dead he would be.",
		SPIDER_WARRIOR = "Shoo, you nasty thing!",
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "SO. I come from there?",
        ...
        ABIGAIL_FLOWER =
        {
            GENERIC ="Some beautiful soul's there.",
            LONG = "My soul's burning in desire. BE FREE.",
            MEDIUM = "I find pleasant to look at that.",
            SOON = "Her soul is making weird things!",
        ...
        PLAYER =
        {
            GENERIC = "%s I could eat you...",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
            FIRESTARTER = "Now burn me, honey.",
        },
        WILSON =
        {
            GENERIC = "I like your funny pointy hair",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WAXWELL =
        {
            GENERIC = "You seem polite or something, %s!",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WX78 =
        {
            GENERIC = "Did the alfarians made you?",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WENDY =
        {
            GENERIC = "Nice hair, I like blondies, %s!",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WOODIE =
        {
            GENERIC = "Greetings wood-chopper, %s!",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
            FIRESTARTER = "Now burn me, honey.",
            BEAVER = "You handsome beaver!",
            BEAVERGHOST = "Will you bea-very mad if I don't revive you, %s?",
            MOOSE = "A moose! that's one big animal right there",
        ...
        WES =
        {
            GENERIC = "So you don't talk? You can't annoy me, %s! Charming!",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WEBBER =
        {
            GENERIC = "Woah, a wholesome spider!",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        WATHGRITHR =
        {
            GENERIC = "Oh hello fellow pretty warrior, what do you think about scissors? As a weapon obviously...",
            ATTACKER = "%s, promising foe!",
            MURDERER = "Doesn't really annoys me",
            REVIVER = "%s, now you can touch me again...",
            GHOST = "%s could use a heart. ",
        ...
        BELL = "Grrr. I don't like high-pitched noises",
        STATUEGLOMMER =
        {
		...
		EVERGREEN =
		{
			...
			BURNT = "I feel like I could have prevented that.",
			CHOPPED = "Take that, nature!",
			GENERIC = "You could pin-e me with that.",
		},
		EVERGREEN_SPARSE =
		{
			BURNING = "What a waste of wood.",
		...
		TWIGGYTREE = 
		{
			...
			BURNT = "I feel like I could have prevented that.",
			CHOPPED = "Take that, nature!",
			GENERIC = "You could... You know... Stick me with that...",			
		...
		SMALLBIRD =
		{
			GENERIC = "I like small things... Like this bird!",
